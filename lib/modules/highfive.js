...
app.event.on('module_highfive_remove', function(){
    ...
    app.commands.unregister(cmdname_upper);
    app.commands.unregister(cmdname_alt_upper);
...
app.event.on('module_highfive_load', function(){
    app.commands.register(cmdname, eventname, false, '');
    app.commands.register(cmdname_alt, eventname, false, '');
    app.commands.register(cmdname_upper, eventname, false, '');
    app.commands.register(cmdname_alt_upper, eventname, false, '');
});
